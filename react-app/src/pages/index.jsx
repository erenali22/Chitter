...
const menuList = [
  { title: "Explore", Icon: <NumberOutlined style={{ fontSize: 28 }} /> },
...
export default function Home() {
  ...
  const fetchFeedData = () => {
    ...
    getUserFeed().then((fetchedChatters) => {
      setChatters(
        Array.isArray(fetchedChatters?.chatters)
          ? fetchedChatters?.chatters
          : [],
      );
    });
  };
    ...
    <>
      <div className={styles.app}>
            ...
            .concat(
              isLoaded
                ? [
                    ...
                    {
                      title: "Login out",
                      Icon: <LogoutOutlined style={{ fontSize: 28 }} />,
                    },
                  ]
                : [],
            )
        ...
        <div style={{ flex: 1, paddingLeft: 20, paddingTop: 60 }}>
          <span style={{ fontSize: 30 }}>{activeTab}</span>
          {getContent()}
        </div>
      </div>
